...
for (iter in 1:nrow(parameter_grid)){
  ...
  for (t in 2:timesteps) {
    ...
    harvest[t,] <- population[t-1,] * (1 - exp(- fishing_effort * catchability)) * 
    ...
    #harvest and population growth
    harvest_r1[t,] <- population_r1[t-1,] * (1 - exp(- fishing_effort * catchability)) * 
      as.numeric(parameter_grid[['patch_area']][[iter]])
    ...
    harvest_r2[t,] <- population_r2[t-1,] * (1 - exp(- fishing_effort * catchability)) * 
      as.numeric(parameter_grid[['patch_area']][[iter]])
    ...
    harvest_r3[t,] <- population_r3[t-1,] * (1 - exp(- fishing_effort * catchability)) * 
      as.numeric(parameter_grid[['patch_area']][[iter]])
    ...
    harvest_K1[t,] <- population_K1[t-1,] * (1 - exp(- fishing_effort * catchability)) * 
      as.numeric(parameter_grid[['patch_area']][[iter]])
    ...
    harvest_K2[t,] <- population_K2[t-1,] * (1 - exp(- fishing_effort * catchability)) * 
      as.numeric(parameter_grid[['patch_area']][[iter]])
